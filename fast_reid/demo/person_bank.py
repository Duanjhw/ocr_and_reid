...
import sys
sys.path.append('/home/user/tongchonggang/Yolov5-Deepsort-Fastreid/fast_reid')
import math
...
def get_parser():
    ...
    parser.add_argument(
        "--input",
        # nargs="+",
        default='/home/user/tongchonggang/Yolov5-Deepsort-Fastreid/image_feature/*.png',
        help="A list of space separated input images; "
             "or a single glob pattern such as 'directory/*.jpg'",
    )
    parser.add_argument(
        "--output",
        default='/home/user/tongchonggang/Yolov5-Deepsort-Fastreid/features/demo_output',
...
if __name__ == '__main__':
    ...
    cos_sim = cosine_similarity(embs[:-1, :], query)
    print(cos_sim)
